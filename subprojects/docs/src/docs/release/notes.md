...
The Eclipse classpath file generated by the plugin has the following changes:
 ...
 - All source sets and dependencies defined by the JVM Test Suite plugin are also marked as tests by default
...
Note, that these change improve the [Buildship](https://eclipse.org/buildship) project synchronization as well.
